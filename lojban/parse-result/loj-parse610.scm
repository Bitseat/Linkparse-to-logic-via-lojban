;la tom cu rirpa'u la maris
              (EvaluationLink (stv 1.000000 0.900000)
                (PredicateNode "sumti2") ; [3867787191736896719][1]
                  (ListLink
                  (PredicateNode "50yMKK0SmqpqqCNkYQSf___cmene") ; [344904913859175098][1]
                  (ConceptNode "eYTUHtoRK6202HVOIWpw" (stv 0.000001 0.010000)) ; [2449871827499346134][1]
                       )
                )
              (EvaluationLink (stv 0.750000 0.900000)
                (PredicateNode "sumti1") ; [1918104841823416311][1]
                  (ListLink
                  (PredicateNode "6DwN2LVC4FfiGRyOwhKX___rirpa'u") ; [6404677182483495523][1]
                  (ConceptNode "eYTUHtoRK6202HVOIWpw" (stv 0.000001 0.010000)) ; [2449871827499346134][1]
                       )
                )
              (EvaluationLink (stv 0.750000 0.900000)
                (PredicateNode "sumti2") ; [3867787191736896719][1]
                  (ListLink
                  (PredicateNode "6DwN2LVC4FfiGRyOwhKX___rirpa'u") ; [6404677182483495523][1]
                  (ConceptNode "vWhHNnwlxgWF3ZPKNcJM" (stv 0.000001 0.010000)) ; [8421288778084164929][1]
                       )
                )
            (ImplicationLink (stv 1.000000 0.900000)
              (PredicateNode "6DwN2LVC4FfiGRyOwhKX___rirpa'u") ; [6404677182483495523][1]
              (PredicateNode "rirpa'u") ; [6246203092176015310][1]
)
              (EvaluationLink (stv 1.000000 0.900000)
                (PredicateNode "sumti2") ; [3867787191736896719][1]
                  (ListLink
                  (PredicateNode "5UHvQYKitQWFRUQbB8MU___cmene") ; [6605159208639487207][1]
                  (ConceptNode "vWhHNnwlxgWF3ZPKNcJM" (stv 0.000001 0.010000)) ; [8421288778084164929][1]
                       )
                )
