;Interesting Pattern Mining results for 3 gram patterns. Total pattern number: 1031
...
; { [0]=
; { [1]=
; { [2]=1/117=0.00854701 [01]=4/117=0.034188, expect = 0.000292205x117 = 0.034188, nDiff = 57.5}
; { [0]=

;Pattern: Frequency = 2, SurprisingnessI = 57.5, SurprisingnessII = 5.85e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "IV")
  (ListLink
    (PatternVariableNode "$var_1")
