;Interesting Pattern Mining final results for 2 gram patterns. Total pattern number: 24
...
;Pattern: Frequency = 2, SurprisingnessI = 1e+09, SurprisingnessII = 4.75e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "EB")
  (ListLink
    (PatternVariableNode "$var_1")
