;Interesting Pattern Mining results for 3 gram patterns. Total pattern number: 482

;p = 2/95 = 0.0210526

; { [0]=
; { [1]=1/95=0.0105263 [02]=2/95=0.0210526, expect = 0.000221607x95 = 0.0210526, nDiff = 94}
; { [2]=
; { [0]=

;Pattern: Frequency = 2, SurprisingnessI = 94, SurprisingnessII = 4.75e+10
(EvaluationLink
