;Interesting Pattern Mining final results for 3 gram patterns. Total pattern number: 30
...
; { [0]=
; { [1]=1/105=0.00952381 [02]=13/105=0.12381, expect = 0.00117914x105 = 0.12381, nDiff = 15.1538}
; { [2]=
; { [0]=

;Pattern: Frequency = 2, SurprisingnessI = 15.1538, SurprisingnessII = 5.25e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "EB")
  (ListLink
    (PatternVariableNode "$var_1")
