;Interesting Pattern Mining final results for 3 gram patterns. Total pattern number: 34
...
; { [0]=
; { [1]=
; { [2]=1/95=0.0105263 [01]=5/95=0.0526316, expect = 0.000554017x95 = 0.0526316, nDiff = 37}
; { [0]=

;Pattern: Frequency = 2, SurprisingnessI = 37, SurprisingnessII = 1e+09
(EvaluationLink
  (LinkGrammarRelationshipNode "D")
  (ListLink
    (PatternVariableNode "$var_1")
