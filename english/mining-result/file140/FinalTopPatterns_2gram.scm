;Interesting Pattern Mining final results for 2 gram patterns. Total pattern number: 10
...
;Pattern: Frequency = 2, SurprisingnessI = 1e+09, SurprisingnessII = 2.05e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "W")
  (ListLink
    (PatternVariableNode "$var_1")
