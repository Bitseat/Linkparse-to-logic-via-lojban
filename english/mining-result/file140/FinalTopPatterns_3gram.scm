;Interesting Pattern Mining final results for 3 gram patterns. Total pattern number: 15
...
; { [0]=1/41=0.0243902 [12]=6/41=0.146341, expect = 0.0035693x41 = 0.146341, nDiff = 12.6667}
; { [1]=
; { [2]=
; { [0]=1/41=0.0243902 [1]=

;Pattern: Frequency = 2, SurprisingnessI = 12.6667, SurprisingnessII = 2.05e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "R")
  (ListLink
    (PatternVariableNode "$var_1")
