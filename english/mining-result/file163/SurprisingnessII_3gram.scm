;Interesting Pattern Mining results for 3 gram patterns. Total pattern number: 329

;p = 2/74 = 0.027027

; { [0]=1/74=0.0135135 [12]=8/74=0.108108, expect = 0.00146092x74 = 0.108108, nDiff = 17.5}
; { [1]=
; { [2]=
; { [0]=1/74=0.0135135 [1]=

;Pattern: Frequency = 2, SurprisingnessI = 17.5, SurprisingnessII = 3.7e+10
(EvaluationLink
