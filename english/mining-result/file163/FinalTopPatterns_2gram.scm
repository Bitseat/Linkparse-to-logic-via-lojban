;Interesting Pattern Mining final results for 2 gram patterns. Total pattern number: 17
...
;Pattern: Frequency = 2, SurprisingnessI = 1e+09, SurprisingnessII = 3.7e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "W")
  (ListLink
    (PatternVariableNode "$var_1")
