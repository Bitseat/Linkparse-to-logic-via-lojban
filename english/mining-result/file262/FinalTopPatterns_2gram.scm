;Interesting Pattern Mining final results for 2 gram patterns. Total pattern number: 22
...
;Pattern: Frequency = 2, SurprisingnessI = 1e+09, SurprisingnessII = 2.45e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "W")
  (ListLink
    (PatternVariableNode "$var_1")
