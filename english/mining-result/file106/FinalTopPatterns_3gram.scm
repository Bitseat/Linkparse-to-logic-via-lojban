;Interesting Pattern Mining final results for 3 gram patterns. Total pattern number: 8
...
; { [0]=1/15=0.0666667 [12]=3/15=0.2, expect = 0.0133333x15 = 0.2, nDiff = 9}
; { [1]=
; { [2]=
; { [0]=1/15=0.0666667 [1]=

;Pattern: Frequency = 2, SurprisingnessI = 9, SurprisingnessII = 7.5e+09
(EvaluationLink
  (LinkGrammarRelationshipNode "R")
  (ListLink
    (PatternVariableNode "$var_1")
