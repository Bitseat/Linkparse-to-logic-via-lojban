;Interesting Pattern Mining final results for 3 gram patterns. Total pattern number: 6
...
; { [0]=
; { [1]=1/26=0.0384615 [02]=3/26=0.115385, expect = 0.00443787x26 = 0.115385, nDiff = 16.3333}
; { [2]=
; { [0]=

;Pattern: Frequency = 2, SurprisingnessI = 16.3333, SurprisingnessII = 1e+09
(EvaluationLink
  (LinkGrammarRelationshipNode "MV")
  (ListLink
    (PatternVariableNode "$var_1")
