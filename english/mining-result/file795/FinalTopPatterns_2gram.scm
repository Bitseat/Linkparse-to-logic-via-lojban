;Interesting Pattern Mining final results for 2 gram patterns. Total pattern number: 23
...
;Pattern: Frequency = 2, SurprisingnessI = 1e+09, SurprisingnessII = 3.35e+10
(EvaluationLink
  (LinkGrammarRelationshipNode "MV")
  (ListLink
    (PatternVariableNode "$var_1")
